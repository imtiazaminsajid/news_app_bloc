...
class AppColors {
  // static const Color appBackground = Color(0xffFBFBFB);
  static const Color appBackground = Color(0xffF4F4F4);
  static const Color primaryColor = Color(0xff008541);
  // static const Color secondaryColor =const  Color(0xff292929);
  // static const Color facebookBlue =const  Color(0xff415893);
  // static const Color googleBlue =const  Color(0xff5A94EE);
  // static const Color secondaryTwoColor =const  Color(0xffF6F6F6);
